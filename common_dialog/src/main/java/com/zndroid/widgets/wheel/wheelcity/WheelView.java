package com.zndroid.widgets.wheel.wheelcity;

import java.util.LinkedList;
import java.util.List;

import com.zndroid.widgets.utils.ReflectResourceUtil;
import com.zndroid.widgets.wheel.wheelcity.adapters.WheelViewAdapter;
	...
	private void initResourcesIfNecessary() {
		if (centerDrawable == null) {
			centerDrawable = getContext().getResources().getDrawable(
					ReflectResourceUtil.getDrawableId(getContext(), "zcommon_wheel_val"));
		}
		...
		setBackgroundResource(ReflectResourceUtil.getDrawableId(getContext(), "zcommon_wheel_bg"));
	}
