package com.zndroid.widgets.wheel.wheelview;
...
public class WheelMain {
	...
	public WheelMain(View view, Context context, boolean hasSelectTime) {
		super();
		this.view = view;
		this.context = context;
	...
	public void initTimePicker(int h, int m) {
		// 年
		wv_year = (WheelView) view.findViewById(ReflectResourceUtil.getId(
				context, "year"));
		// 月
		wv_month = (WheelView) view.findViewById(ReflectResourceUtil.getId(
				context, "month"));
		// 日
		wv_day = (WheelView) view.findViewById(ReflectResourceUtil.getId(
				context, "day"));
		
		wv_hours = (WheelView) view.findViewById(ReflectResourceUtil.getId(
				context, "hour"));
		wv_minutes = (WheelView) view.findViewById(ReflectResourceUtil.getId(
				context, "min"));
		if (onlyTime) {
