package com.zndroid.widgets.progress;
...
/**
 * @author luzhenyu
 * <p>CircularProgress - 自定义圆形彩虹进度条控件</p>
 * */
public class CircularProgress extends View {
    ...
    /*
    private int[] mColors = {R.color.rainbow_red,R.color.rainbow_orange,R.color.rainbow_yellow,
    		R.color.rainbow_green,R.color.rainbow_navy,R.color.rainbow_blue,R.color.rainbow_purple};
    		*/
    ...
    public CircularProgress(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, ReflectResourceUtil.getStyleableIntArray(getContext(), "CircularProgress"), defStyleAttr, 0);
        mBorderWidth = a.getDimension(ReflectResourceUtil.getStyleableFieldId(getContext(), "CircularProgress", "borderWidth"),
